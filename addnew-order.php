...
console.log(timestamp+'>>'+ts);	
 ...
 <?php  
  ...
  $query_count = "SELECT p.deparure from orders o left join plans p on o.plan_id=p.id where o.id=$rows->order_id";
  
  $select_count_query = mysqli_query($connection,$query_count); 

  $count =  $select_count_query->fetch_object();
  ...
  ?>
                                                                                                                   ...
                                                                                                                   count down  
                                                                                                                    ...
                                                                                                                    <span id='countdown_span_<?php echo $rows->order_id ?>'>
                                                                                                                        <script>
                                                                                                                        set_countdown(<?= $count->deparure ?>,'countdown_span_<?php echo $rows->order_id ?>')
                                                                                                                        </script>
                                                                                                                </span>
                                                                                                                </div>  
                                                                                                            </div>
   ...
   <tbody>
        ...
        <tbody>
                       ...
                       <td><textarea type="text" name="spcial-comments3" class="credit" placeholder="comment"></textarea>
                        ...
                        <button type="submit" value="orderNow"> Order Now</button>
                 </form>
